...
# Python.TTF2PNG.BitmapFontPython.Pyxel.Load.BitmapFont.20200402070000

Reads and displays PNG images as bitmap fonts.
...
* pyxel: Japanese output to pyxel screen using PNG and text
